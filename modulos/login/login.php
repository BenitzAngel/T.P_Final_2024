...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Panaderia la Reina</title>
...
<main class="form-signin w-100 m-auto">
  <form id="loginForm">
    ...
    <h1 class="h3 mb-3 fw-normal">Inicio de seción</h1>
    </div>
    ...
    <div class="form-floating">
      <input type="password" class="form-control" id="contrasenia" name="contrasenia" placeholder="Ingrese Contraseña">
      <label for="floatingContrasenia">Contraseña</label>
    </div>
    ...
    <button class="btn btn-primary w-100 py-2" type="submit" name="ingresar">Inicio</button>
    <div style= "text-align:center;">
